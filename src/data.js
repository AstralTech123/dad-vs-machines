...
const EDEFS = {
  ...
  scoot:{ name:'E-Scooter', hp:26, spd:150, dmg:8, r:15, cost:3, minW:7, mats:2, weight:5, ai:'charge' },
  thermo:{ name:'Smart Thermostat', hp:38, spd:60, dmg:0, shot:9, r:16, cost:3.5, minW:9, mats:3, weight:4, ai:'shoot' },
  frido:{ name:'Smart Fridge', hp:150, spd:36, dmg:14, r:26, cost:6, minW:10, mats:5, weight:3, ai:'chase', knockR:0.15 },
  courier:{ name:'BOLT COURIER', hp:60, spd:150, dmg:0, r:16, cost:0, minW:99, mats:0, weight:0, ai:'courier', knockR:0.15, courier:true },
  vend:{ name:'VENDING MACHINE', hp:170, spd:38, dmg:0, shot:8, r:24, cost:0, minW:99, mats:0, weight:0, ai:'printer', knockR:0.25, elite:true },
